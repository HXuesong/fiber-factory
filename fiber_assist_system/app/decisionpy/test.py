...
class HdfsClient(object):
    ...
    def __init__(self, conf=None):
        ...
        self.loc_conf = {
            'final_table_local_path': r'G:\tongding_projrct\app\decisionpy\final_table.csv',
            'nearest_point_table_local_path': r'G:\ongding_projrct\app\decisionpy\nearest_point_table.csv',
            'merged_point_table_local_path': r'G:\tongding_projrct\app\decisionpy\merged_point_table.csv',
            'general_info_local_path': r'E:\PYProject\tongding_projrct\app\decisionpy\general_info.txt',
